...
export default function HeroReab() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-white/80 text-xs font-medium tracking-widest uppercase">
                Reabilitação Oral · Barra da Tijuca
              </span>
            </div>
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-playfair), serif" }}
            >
              Reabilitação total com implantes e prótese fixa.
            </p>

            <p className="text-white/75 text-lg leading-relaxed mb-8 max-w-lg">
              Para quem perdeu vários dentes ou convive com prótese removível.{" "}
              <strong className="text-white font-semibold">Planejamento digital completo</strong>,
              cirurgia guiada e prótese fixa — resultado que dura décadas.
              Particular. Barra da Tijuca, RJ.
            </p>
          ...
          >
            <div className="relative w-[420px] h-[520px] rounded-3xl overflow-hidden shadow-2xl">
              <Image
                src="/dr-andre.jpg"
                alt="Dr. André Daniel — Reabilitação Oral Completa na Barra da Tijuca, RJ"
                fill
