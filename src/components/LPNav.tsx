...
export default function LPNav() {
  return (
    <nav className="fixed top-8 left-0 right-0 z-40 px-6">
      <div className="max-w-6xl mx-auto flex items-center justify-between bg-[#0F2840]/80 backdrop-blur-md border border-white/10 rounded-full px-5 py-3 shadow-lg">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          />
          <span
            className="text-white font-semibold text-sm hidden sm:block group-hover:text-[#C49A15] transition-colors"
