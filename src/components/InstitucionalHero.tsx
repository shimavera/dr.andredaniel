...
export default function InstitucionalHero() {
  return (
    <section className="relative bg-[#173B5E] overflow-hidden flex flex-col justify-center pt-16 pb-20">
      {/* Background gradient */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/75 text-lg leading-relaxed mb-8 max-w-lg">
              ...
              Tomografia, escaneamento 3D e cirurgia guiada. Só atendimento particular.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              ...
              <Link
                href="/implantes"
                className="flex items-center gap-2 border border-[#C49A15]/50 hover:border-[#C49A15] text-[#C49A15] hover:text-white font-medium px-7 py-4 rounded-full transition-all hover:bg-[#C49A15]/10"
              >
                Quero implante dentário
                <span>→</span>
              </Link>
            </div>
